...
export default function MovilEnergia(props: Props) {
  ...
  bombillas_c: Number(valores?.[indiceOriginal]?.[1]?.c || 0),
  bombillas_nc: Number(valores?.[indiceOriginal]?.[1]?.nc || 0),

  reflectores_c: Number(valores?.[indiceOriginal]?.[2]?.c || 0),
  reflectores_nc: Number(valores?.[indiceOriginal]?.[2]?.nc || 0),

  lamparas_c: Number(valores?.[indiceOriginal]?.[3]?.c || 0),
  lamparas_nc: Number(valores?.[indiceOriginal]?.[3]?.nc || 0),

  aires_c: Number(valores?.[indiceOriginal]?.[4]?.c || 0),
  aires_nc: Number(valores?.[indiceOriginal]?.[4]?.nc || 0),
