...
const obtenerEstadoConsumo = (
  ...
  if (!promedio || consumo === 0) return "normal";
  if (consumo > promedio * 1.5) return "critico";
  if (consumo > promedio * 1.2) return "alerta";
  return "normal";
};
  ...
  async function guardarAguaEnBD(
    mes: number,
    dia: number,
    data: LecturaDia
  ) {
    ...
    diasMes.forEach(({ dia, tipo }) => {
      ...
      actual.total2 =
        actual.bodega2 && lecturaAnterior.bodega2
          ? (Number(actual.bodega2) - Number(lecturaAnterior.bodega2)) / FACTOR_CONVERSION
          : 0;

      actual.total4 =
        actual.bodega4 && lecturaAnterior.bodega4
          ? (Number(actual.bodega4) - Number(lecturaAnterior.bodega4)) / FACTOR_CONVERSION
          : 0;
          ...
          <div className="flex items-start gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-sm opacity-70">
                Filtra el consumo de agua por mes, año, día o tipo de día
              </p>
            </div>
          </div>
